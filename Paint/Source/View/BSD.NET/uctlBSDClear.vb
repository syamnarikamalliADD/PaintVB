...
#Region " Declares "
    ...
    'NVSP => The number of predetcs has been increased from a normal 10. Z4BOOTHQUEUE GUI now can handle 15 predetects and and 20 post detects
...
#Region " Routines "
    ...
    Private Sub subSetToolTips()
        ...
        With ttDesc
            ...
            .SetToolTip(picEstop02, gpsRM.GetString("psESTOP_FS_Ent"))
            '.SetToolTip(picEstop03, gpsRM.GetString("psESTOP_FS_Exit"))
    ...
    Private Sub subInitFormText()
        ...
        ' Date      By      Reason
        '********************************************************************************************
        'NVSP 6 -> 13 as there are 14 predetects
        Call InitCommonText(Me, 14, 0, mnuRobotContext, 6, mnuOnOff)
    ...
    Public Sub UpdatePLCData(Optional ByVal pLink As ePLCLink = ePLCLink.None) Implements BSDForm.UpdatePLCData
        ...
        Select Case pLink
            ...
            Case ePLCLink.Robot
                ...
                'NVSP 10/28/2016 15 words per equipment and 30 words for the robot controller in total
                Dim sRData(2 * eRobot.WordsPerRobot - 1) As String
                ...
                For i As Integer = 0 To nUB
                    ...
                    'NVSP 10/28/2016 15 words per equipment and 30 words for the robot controller in total
                    If nOffSet = (2 * eRobot.WordsPerRobot - 1) Then
