...
#Region " Declares "
    ...
    '******** Cartoon Variables   *******************************************************************
    'NVSP 11/09/2016 changed the size of the screen
    Private Const mnTOON_WIDTH As Integer = 700 '316
...
#Region " Routines "
    ...
    Friend Sub Initialize(Optional ByVal sParam As String = "") Implements BSDForm.Initialize
        ...
        '********************************************************************************************
        Const nLabelHeight As Integer = 25 'AVB 10/9/14 made the cell height bigger to accommodate for longer text
        ...
        For Each oArm As clsArm In frmMain.colArms
            ...
            Select Case oArm.ColorChangeType
                Case eColorChangeType.BELL_2K, eColorChangeType.GUN_2K, eColorChangeType.VERSABELL_2K, _
                     ...
                     eColorChangeType.GUN_2K_PIG, eColorChangeType.GUN_2K_Mica 'NVSP 12/12/2016 To get hold of piggable
                    bIPC = True
                    b2K = True
