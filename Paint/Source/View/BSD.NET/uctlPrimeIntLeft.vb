...
#Region " Routines "
    ...
    Friend Sub Initialize(Optional ByVal sParam As String = "") Implements BSDForm.Initialize
        ...
        mBSDCommon.TrackingScale = -0.52
        mBSDCommon.TrackingStartPos = 1119
    ...
    Private Sub subSetToolTips()
        ...
        With ttDesc
            ...
            .SetToolTip(picEstatPowerSS, gpsRM.GetString("psESTAT_DISC"))
            .SetToolTip(picEstop01, gpsRM.GetString("psESTOP") & " #1") '_NS_Ent"))
            .SetToolTip(picEstop02, gpsRM.GetString("psESTOP") & " #2") '_FS_Ent"))
            .SetToolTip(picEstop03, gpsRM.GetString("psESTOP") & " #3") '_NS_Exit"))
            .SetToolTip(picEstop04, gpsRM.GetString("psESTOP") & " #4") '_FS_Exit"))
            ...
            .SetToolTip(picLimitSw0, gpsRM.GetString("psMUTE_SW_TT") & "2")
            .SetToolTip(picLimitSw1, gpsRM.GetString("psMUTE_SW_TT") & "1")
