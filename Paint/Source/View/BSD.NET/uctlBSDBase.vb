...
#Region " Declares "
    ...
    'NVSP 03092016 GUI Carrior Graphics
...
#Region " Routines "
    ...
    Private Sub subSetToolTips()
        ...
        With ttDesc
            ...
            .SetToolTip(picEstop02, gpsRM.GetString("psESTOP_FS_Exit"))
    ...
    Private Sub subInitFormText()
        ...
        'NVSP 03082017 Adding constant for number of post detect queue positions
        Call InitCommonText(Me, 6, 0, mnuRobotContext, 6, mnuOnOff)
    ...
    Friend Overloads Sub Show(ByVal StartData As String()) Implements BSDForm.Show
        ...
        LinkIndex = ePLCLink.myQueue
        PLCData = frmMain.GetCachedData(ePLCLink.myQueue)
