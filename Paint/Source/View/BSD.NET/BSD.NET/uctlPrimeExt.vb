...
#Region " Routines "
    ...
    Friend Sub Initialize(Optional ByVal sParam As String = "") Implements BSDForm.Initialize
        ...
        mBSDCommon.TrackingScale = -0.365
        mBSDCommon.TrackingStartPos = 1191
        ...
        For i As Integer = 1 To mnDOORS
            ...
            With oDoorLbl
                Select Case i
                    ...
                    Case 2
                        'Hinge Lower Right
                        tDoors(i).Hinge = New Point(.Right - 2, .Bottom - 2)
                        'Close Lower Left
                        tDoors(i).Close = New Point(.Left + 2, .Bottom - 2)
                        'Open Upper Left
                        tDoors(i).Open = New Point(.Left + 2, .Top + 2)
                End Select
            End With 'oDoorLbl
        Next 'i
        ...
        For i As Integer = 1 To mnSILHOUETTES
            ...
            With oGateLbl
                Select Case i
                    Case 1, 3
                        'Hinge Upper Left
                        tSilhouettes(i).Hinge = New Point(.Right - 2, .Bottom - 2) 'New Point(.Left + 2, .Top + 2)
                        'Close Lower Left
                        tSilhouettes(i).Close = New Point(.Right - 2, .Top + 2) 'New Point(.Left + 2, .Bottom - 2)
                        'Open Lower Right
                        tSilhouettes(i).Open = New Point(.Left + 2, .Top + 2) 'New Point(.Right - 2, .Bottom - 2)
                    Case 2, 4
                        'Hinge Lower Left 
                        tSilhouettes(i).Hinge = New Point(.Right - 2, .Top + 2) 'New Point(.Left + 2, .Bottom - 2)
                        'Close Upper Left
                        tSilhouettes(i).Close = New Point(.Right - 2, .Bottom - 2) 'New Point(.Left + 2, .Top + 2)
                        'Open Upper Right
                        tSilhouettes(i).Open = New Point(.Left + 2, .Bottom - 2) 'New Point(.Right - 2, .Top + 2)
                End Select
            End With 'oGateLbl
        Next 'i
    ...
    Private Sub subSetToolTips()
        ...
        With ttDesc
            ...
            .SetToolTip(picEstop03, gpsRM.GetString("psESTOP") & " #1") '_FS_Ent"))
            .SetToolTip(picEstop04, gpsRM.GetString("psESTOP") & " #2") '_FS_Exit"))
            .SetToolTip(picEstop01, gpsRM.GetString("psESTOP") & " #3") '_FS_Ent"))
            .SetToolTip(picEstop02, gpsRM.GetString("psESTOP") & " #4") '_FS_Exit"))
            ...
            .SetToolTip(picLimitSw1, gpsRM.GetString("psMUTE_SW_TT") & "2")
            .SetToolTip(picLimitSw0, gpsRM.GetString("psMUTE_SW_TT") & "1")
            .SetToolTip(picLimitSw2, gpsRM.GetString("psMUTE_SW_TT") & "3")
        End With
