...
#Region " Declares "
    ...
    Private mfTrackingScale As Single = 1.0
...
#Region " Routines "
    ...
    Friend Sub EnableRobotMenus(ByRef oMnu As ContextMenuStrip, ByRef sZoneData As String(), _
        ...
        oSubMnu.DropDownItems(sMnuName & "Purge" & gsALL).Enabled = False
        ...
        oSubMnu.DropDownItems("mnuMoveSeparator1").Visible = Not nRobotType = eArmType.P500
        oSubMnu.DropDownItems(sMnuName & "ClearPath").Visible = Not nRobotType = eArmType.P500
        ...
        oMnu.Items("mnuEasyButton").Enabled = bTempEnable
    ...
    Friend Sub InitCommonText(ByRef rUctl As UserControl, _
        ...
        '********************************************************************************************
        Dim oCulture As Globalization.CultureInfo = frmMain.DisplayCulture
        Dim oController As clsController = frmMain.colControllers.Item(1)
        Dim bV70 As Boolean
    ...
    Friend Sub QueuePositionChange(ByRef QPosData As String(), ByRef sNum As String, Optional ByRef uctlJob As uctlList = Nothing, Optional ByRef pnlJob As Panel = Nothing)
        ...
        Try
            ...
            Dim nLBL_STATUS As Integer = 6 '5 RJO 10/02/14
            ...
            Else
                ...
                Else
                    sColor = gpsRM.GetString("psCOLOR_LBL", oCulture) & QPosData(eQueue.Color)
                End If
                'option
                ...
                If bDoPanel Then
                    ...
                    'Private mnTrackingStartPos As Integer = 0
                    'Private mnTrackingQueueCountsBeforeShift As Integer = 100
                    Dim nPos As Integer = mnTrackingStartPos + _
                       CInt((nPosQ + (nQueueShiftPoint * (CInt(sNum) - 1))) * mfTrackingScale)
                    pnlJob.Left = nPos
                ...
                If bDoList Then
                    ...
                    uctlJob.LabelText(nLBL_TUTONE) = sTutone
