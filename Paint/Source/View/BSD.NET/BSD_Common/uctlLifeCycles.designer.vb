...
Partial Class uctlLifeCycles
    ...
    Private Sub InitializeComponent()
        ...
        Me.gpbEstatCable.Visible = False
        '
        'ftbEstatTol1
        '
