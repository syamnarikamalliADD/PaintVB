...
'    01/14/14   MSW     Add some error handling when reading wbHelp.DocumentText      4.01.06.02
'********************************************************************************************
...
#End Region
    ...
    Private Sub tlspPrintHelp_ButtonClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tlspPrintHelp.ButtonClick
        ...
        Try
            ...
            frmMain.mPrintHtml.subPrintDoc(False)   'JZ 12072016 - Go to print instead of save
        Catch ex As Exception
    ...
    Private Sub tlspSaveHosts_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tlspSaveHosts.Click
        '********************************************************************************************
        'Description: print function
        '
        'Parameters: none
        ...
        Try
            ...
            frmMain.mPrintHtml.subPrintDoc(True)
        Catch ex As Exception
            mDebug.WriteEventToLog(frmMain.msSCREEN_NAME & " Module: " & msMODULE & " Routine: tlspSaveHosts_Click", _
                       "Error: " & ex.Message & vbCrLf & "StackTrace: " & ex.StackTrace)
        End Try
    End Sub
