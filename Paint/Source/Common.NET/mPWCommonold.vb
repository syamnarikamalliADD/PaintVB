...
'    03/24/14   DJM     Added HasManualCycles property to filter arms in sealer appl.      4.01.06.01
'    05/20/14   MSW     IPFromHostName - Don't return 0000 for the first disabled adapter  4.01.07.00
'********************************************************************************************
Option Compare Text
Option Explicit On
Option Strict On
    ...
    Friend Function SaveToChangeLog(ByRef oZone As clsZone, Optional ByRef oCursor As System.Windows.Forms.Cursor = Nothing) As Boolean
        ...
        Try
            ...
            For Each tC As tChange In colChangesSQL
                ...
                Dim sDesc As String = tC.Specific.ToString 'RJO 10/01/12
