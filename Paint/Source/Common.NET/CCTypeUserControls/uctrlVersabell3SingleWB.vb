...
' FANUC LTD Japan
'
' Form/Module: uctrlVersabell3dualwb.vb'
' Description: Versabell 3 dual can wb cartoon control
' 
'
...
'    09/16/13   MSW     first draft                                                   4.01.05.00
'********************************************************************************************
Option Compare Binary
Option Explicit On
Option Strict On

Public Class uctrlVersabell3SingleWB
    ...
    Sub UpdateCartoons() Implements CCToonUctrl.UpdateCartoons
        Try
            ...
            UctrlGroupValve15.ValveColor = uctrlValve.eValveColor.Blue 'pIAIR
            'IAIR
            ...
            If (GetBitState(mnGroupValveStates, 9) = 1) Then 'pSOL2
            ...
            UctrlGroupValve13.ValveColor = nColStkValveColor
            ...
            'VAIR
            If (GetBitState(mnGroupValveStates, 23) = 1) Then
                UctrlGroupValve23.ValvState = True
                lblLineVAIR.BackColor = Color.Blue
                lblLineVAIR2.BackColor = Color.Blue
            Else
                UctrlGroupValve23.ValvState = False
                lblLineVAIR.BackColor = Color.Black
                lblLineVAIR2.BackColor = Color.Black
            End If
    ...
    Private Sub UctrlGroupValve_Click(ByVal sender As Object) Handles UctrlGroupValve0.ValveClick, UctrlGroupValve1.ValveClick, UctrlGroupValve2.ValveClick, UctrlGroupValve3.ValveClick, _
        ...
        UctrlGroupValve11.ValveClick, UctrlGroupValve13.ValveClick, UctrlGroupValve10.ValveClick, UctrlGroupValve15.ValveClick, UctrlGroupValve12.ValveClick, _
    ...
    Private Sub Me_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            UctrlGroupValve23.ValveColor = uctrlValve.eValveColor.Blue 'VAIR
    ...
    Private Sub lblGroup09_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lblGroup08.Click

    End Sub
    Private Sub UctrlGroupValve9_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles UctrlGroupValve8.Load

    End Sub

    Private Sub UctrlGroupValve12_Load(ByVal sender As System.Object, ByVal e As System.EventArgs)
