...
Public Class uctrlVersabell
    ...
    Sub UpdateCartoons() Implements CCToonUctrl.UpdateCartoons
        Try
            ...
            If (GetBitState(mnGroupValveStates, 1) = 1) Then
                ...
                lblLineACDA.BackColor = Color.Blue
                lblLineACDA2.BackColor = Color.Blue
                lblLineACDA3.BackColor = Color.Blue
            Else
                UctrlGroupValve1.ValvState = False
                lblLineACDA.BackColor = Color.Black
                lblLineACDA2.BackColor = Color.Black
                lblLineACDA3.BackColor = Color.Black
            End If
            'App Cleaner Air
            ...
            'pCC, injector wash, bell wash
            UctrlGroupValve5.ValveColor = nSolvAirValveColor
            UctrlGroupValve9.ValveColor = nSolvAirValveColor
            UctrlGroupValve8.ValveColor = nSolvAirValveColor
            'Lines
            ...
            If (GetBitState(mnGroupValveStates, 8) = 1) Then
                ...
                lblLineBW1.BackColor = nSolvAirBackColor
                lblLineBW2.BackColor = nSolvAirBackColor
            Else
            ...
            Else
                ...
                UctrlGroupValve10.ValveColor = nColStkValveColor
                If UctrlGroupValve10.ValvState = False Then
    ...
    ' Date      By      Reason
    '********************************************************************************************
    Private Sub UctrlGroupValve_Click(ByVal sender As Object) Handles UctrlGroupValve10.ValveClick, UctrlGroupValve9.ValveClick, UctrlGroupValve8.ValveClick, UctrlGroupValve3.ValveClick, _
        UctrlGroupValve4.ValveClick, UctrlGroupValve5.ValveClick, UctrlGroupValve11.ValveClick, UctrlGroupValve7.ValveClick, UctrlGroupValve12.ValveClick, UctrlGroupValve15.ValveClick, UctrlGroupValve1.ValveClick, _
        UctrlGroupValve14.ValveClick, UctrlGroupValve1212.ValveClick, UctrlGroupValve13.ValveClick, UctrlGroupValve2.ValveClick, UctrlGroupValve0.ValveClick
        Try
    ...
    Private Sub Me_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            UctrlGroupValve2.ValveColor = uctrlValve.eValveColor.Blue
            UctrlGroupValve0.ValveColor = uctrlValve.eValveColor.Red
            UctrlGroupValve1.ValveColor = uctrlValve.eValveColor.Blue
            UctrlGroupValve7.ValveColor = uctrlValve.eValveColor.Blue
            UctrlGroupValve12.ValveColor = uctrlValve.eValveColor.Blue
    ...
    Private Sub UctrlGroupValve4_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles UctrlGroupValve4.Load
