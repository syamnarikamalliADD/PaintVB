...
' FANUC LTD Japan
'
' Form/Module: uctrlACP2kbellFlex.vb'
...
'    08/18/11   HGB     Converted from Versabell 2k
...
Public Class uctrlACP2kbellFlex
    ...
    Private Enum eACP2KBellFlexShared
        Trigger = 0
        Reserved2 = 1
        HardenerEnable = 2
        ColorEnable = 3
    End Enum
    Private Enum eACP2KBellFlexGroup
        PPE = 0
        PInjWash = 1
        PBellWash = 2
        PurgeSolv = 3
    ...
    Sub UpdateCartoons() Implements CCToonUctrl.UpdateCartoons
        Try
            ...
            'App Cleaner Air
            If (GetBitState(mnGroupValveStates, eACP2KBellFlexGroup.ACA) = 1) Then
            ...
            End If
            'App Cleaner Solvent
            If (GetBitState(mnGroupValveStates, eACP2KBellFlexGroup.ACS) = 1) Then
            ...
            End If
            'ACVA
            If (GetBitState(mnGroupValveStates, eACP2KBellFlexGroup.ACVA) = 1) Then
            ...
            End If
            'Seal Air
            If (GetBitState(mnGroupValveStates, eACP2KBellFlexGroup.Seal) = 1) Then
            ...
            End If
            'Pump(Flush)
            If (GetBitState(mnGroupValveStates, eACP2KBellFlexGroup.Flush) = 1) Then
            ...
            End If
            'Pump Flush 2
            If (GetBitState(mnGroupValveStates, eACP2KBellFlexGroup.Flush2) = 1) Then
            ...
            End If
            'Color Enable
            If (GetBitState(mnSharedValveStates, eACP2KBellFlexShared.ColorEnable) = 1) Then
            ...
            'Purge Air
            UctrlGroupValve4.ValvState = (GetBitState(mnGroupValveStates, eACP2KBellFlexGroup.PurgeAir) = 1)
            'Purge Solvent
            UctrlGroupValve3.ValvState = (GetBitState(mnGroupValveStates, eACP2KBellFlexGroup.PurgeSolv) = 1)
            ...
            'p2T - 
            If (GetBitState(mnGroupValveStates, eACP2KBellFlexGroup.P2T) = 1) Then
            ...
            UctrlGroupValve14.ValveColor = nSolvAirOutValveColor 'Pump Flush
            ...
            'Dump 3
            If (GetBitState(mnGroupValveStates, eACP2KBellFlexGroup.Dump3) = 1) Then
            ...
            End If
            'Wash 
            If (GetBitState(mnGroupValveStates, eACP2KBellFlexGroup.pWash) = 1) Then
                UctrlGroupValve14.ValvState = True
                If UctrlGroupValve13.ValvState = True Then 'p2T
            ...
            ''Bell Wash
            'If (GetBitState(mnGroupValveStates, eACP2KBellFlexGroup.PBellWash) = 1) Then
            ...
            If (GetBitState(mnGroupValveStates, eACP2KBellFlexGroup.PCC) = 1) Then
            ...
            'Hdr Stack
            If (GetBitState(mnSharedValveStates, eACP2KBellFlexShared.HardenerEnable) = 1) Then
            ...
            If (GetBitState(mnGroupValveStates, eACP2KBellFlexGroup.PurgeSolv2) = 1) Then
            ...
            If (UctrlSharedValve2.ValvState = False) And (UctrlGroupValve10.ValvState = False) Then
            ...
            'Dump 2
            If (GetBitState(mnGroupValveStates, eACP2KBellFlexGroup.Dump2) = 1) Then
            ...
            'Dump
            If (GetBitState(mnGroupValveStates, eACP2KBellFlexGroup.Dump) = 1) Then
            ...
            'PE valve state
            If (GetBitState(mnGroupValveStates, 0) = eACP2KBellFlexGroup.PPE) Then
                UctrlGroupValve0.ValvState = True
            Else
                UctrlGroupValve0.ValvState = False
            End If
            'IW Valve state
            'If (GetBitState(mnGroupValveStates, 1) = eACP2KBellFlexGroup.PInjWash) Then
            ...
            '    End If
            'End If
            'HGB not using the injector wash or the paint enable since this is an ITW Bell
            '    so just pass it through.  I left the above code in the event they decide they
            '    need the pPE or pIW......
            nBellManBackColor = nMixBackColor
            nBellManValveColor = nMixValveColor
            ...
            If (GetBitState(mnSharedValveStates, eACP2KBellFlexShared.Trigger) = 1) Then
