...
' FANUC LTD Japan
'
' Form/Module: uctrlVersabell2_32.vb'
...
Public Class uctrlVersabell2_32
    ...
    Sub UpdateCartoons() Implements CCToonUctrl.UpdateCartoons
        Try
            ...
            UctrlGroupValve7.ValveColor = nSolvAirValveColor 'Pump Flush
            UctrlGroupValve1.ValveColor = nSolvAirValveColor 'Inj Wash
            UctrlGroupValve2.ValveColor = nSolvAirValveColor 'Bell Wash
    ...
    Private Sub UctrlGroupValve10_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles UctrlGroupValve10.Load
