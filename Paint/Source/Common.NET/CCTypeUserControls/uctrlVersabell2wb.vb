...
' FANUC LTD Japan
'
' Form/Module: uctrlVersabell2WB.vb'
...
Public Class uctrlVersabell2WB
    ...
    Sub UpdateCartoons() Implements CCToonUctrl.UpdateCartoons
        Try
            ...
            UctrlGroupValve11.ValveColor = nSolvAirValveColor 'pWash
            'Lines
            ...
            UctrlGroupValve14.ValveColor = nSolvAirOutValveColor 'pIAIR
            ...
            lblLineColStk6.BackColor = nColStkBackColor
            'Vac, pI valve
            ...
            If (GetBitState(mnGroupValveStates, 12) = 1) Then
                ...
                lblLineDump3_1.BackColor = nColStkBackColor
                lblLineDump3_2.BackColor = nColStkBackColor
            Else
            ...
            If (GetBitState(mnGroupValveStates, 7) = 1) Then
                ...
                nCanValveColor = nColStkValveColor
                nCanBackColor = nColStkBackColor
            Else
