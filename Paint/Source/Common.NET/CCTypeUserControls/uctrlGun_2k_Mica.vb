...
Public Class uctrlGun_2k_Mica
    ...
    Sub UpdateCartoons() Implements CCToonUctrl.UpdateCartoons
        Try
            ...
            'start
            Dim nStkA_BackColor As System.Drawing.Color
            ...
            UctrlSharedValve3.ValvState = (GetBitState(mnSharedValveStates, 4) = 1) 'Stack A CE
            ...
            If (GetBitState(mnSharedValveStates, 3) = 1) Then
                ...
                UctrlSharedValve3.ValveColor = nStkA_ValveColor
            End If
            ...
            lblLineColStkA_3.BackColor = nColStkBackColor
    ...
    Private Sub UctrlSharedValve_Click(ByVal sender As Object) Handles UctrlSharedValve0.ValveClick, UctrlSharedValve0b.ValveClick, _
     UctrlSharedValve1.ValveClick, UctrlSharedValve2.ValveClick, UctrlSharedValve3.ValveClick, UctrlSharedValve3.ValveClick 'NVSP 11/03/2016 Piggable stack changes Added 4 and 5 shared valves 
        Try
            Dim oValve As uctrlValve = DirectCast(sender, uctrlValve)
