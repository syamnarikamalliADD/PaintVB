...
' FANUC LTD Japan
'
' Form/Module: uctrlACP2kBell.vb'
' Description: ACP 2k Bell cartoon control
' 
'
...
Public Class uctrlACP2kBell
    ...
    Private Enum eACP2kBellShared
        Trigger = 0
        Reserved2 = 1
        HardenerEnable = 2
        ColorEnable = 3
    End Enum
    Private Enum eACP2kBellGroup
        Reserved1 = 0
        Reserved2 = 1
        BellWash = 2
        PurgeSolv = 3
    ...
    Sub UpdateCartoons() Implements CCToonUctrl.UpdateCartoons
        Try
            ...
            'App Cleaner Air
            If (GetBitState(mnGroupValveStates, eACP2kBellGroup.ACA) = 1) Then
            ...
            End If
            'App Cleaner Solvent
            If (GetBitState(mnGroupValveStates, eACP2kBellGroup.ACS) = 1) Then
            ...
            End If
            'ACVA
            If (GetBitState(mnGroupValveStates, eACP2kBellGroup.ACVA) = 1) Then
            ...
            End If
            'Purge Air
            UctrlGroupValve4.ValvState = (GetBitState(mnGroupValveStates, eACP2kBellGroup.PurgeAir) = 1)
            'Purge Solvent
            UctrlGroupValve3.ValvState = (GetBitState(mnGroupValveStates, eACP2kBellGroup.PurgeSolv) = 1)
            ...
            'BellWash
            UctrlGroupValve2.ValvState = (GetBitState(mnGroupValveStates, eACP2kBellGroup.BellWash) = 1)
            If (UctrlGroupValve2.ValvState = True) And (UctrlGroupValve13.ValvState = True) Then
                UctrlGroupValve2.ValveColor = nSolvAirValveColor
                lblBellWash.BackColor = nSolvAirBackColor
                lblBellWash1.BackColor = nSolvAirBackColor
            Else
                lblBellWash.BackColor = Color.Black
            End If

            'pCC
            UctrlGroupValve5.ValvState = (GetBitState(mnGroupValveStates, eACP2kBellGroup.PCC) = 1)
            ...
            'Color Enable
            If (GetBitState(mnSharedValveStates, eACP2kBellShared.ColorEnable) = 1) Then
            ...
            Else
                ...
                If (UctrlGroupValve5.ValvState = False) Then 'pcc
                    nColStkValveColor = uctrlValve.eValveColor.Empty
                    nColStkBackColor = Color.Black
                End If
            End If
            ...
            If (GetBitState(mnGroupValveStates, eACP2kBellGroup.Flush) = 1) Then
            ...
            'Purge Solvent 2
            If (GetBitState(mnGroupValveStates, eACP2kBellGroup.PurgeSolv2) = 1) Then
            ...
            'Hardener Enable
            If (GetBitState(mnSharedValveStates, eACP2kBellShared.HardenerEnable) = 1) Then
            ...
            'Pump Flush 2
            If (GetBitState(mnGroupValveStates, eACP2kBellGroup.Flush2) = 1) Then
            ...
            'Dump
            If (GetBitState(mnGroupValveStates, eACP2kBellGroup.Dump) = 1) Then
            ...
            If (GetBitState(mnSharedValveStates, eACP2kBellShared.Trigger) = 1) Then
                UctrlSharedValve0.ValvState = True
                UctrlSharedValve0a.ValvState = True
                lblLineInjector.BackColor = nMixStkBackColor
            Else
