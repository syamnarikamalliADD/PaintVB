...
#Region " Routines "
    ...
    Friend Function GetFile(ByVal SourceFileName As String, ByVal DestFileName As String) As Boolean
        ...
        If msDestDir = String.Empty Then
            msErrorMsg = "Error: Destination Folder not specified." ' gcsRM.GetString("csFTP_ERR_DEST_NOT_SPEC") '
            Return False
        End If

        If SourceFileName = String.Empty Then
            msErrorMsg = "Error: Source File not specified." ' gcsRM.GetString("csFTP_ERR_SRC_NOT_SPEC") '
            Return False
        End If
...
#Region " Events "
    ...
    Public Sub New(ByVal HostName As String)
        ...
        Catch ex As Exception
            Console.WriteLine("FTPUTIL  Module: " & msMODULE & " Routine: New")
            Console.WriteLine("    Error: " & ex.Message & vbCrLf & "StackTrace: " & ex.StackTrace)
        End Try
